...
export const LEGEND_DATA: LegendConfig[] = [
  ...
  },
  {
    ...
    title: "WS [m/s]",
    colors: [
      "rgba(192,0,128.0,1.000)","rgba(188,4,130.6,0.983)","rgba(184,8,133.3,0.967)","rgba(180,12,135.9,0.950)",
      "rgba(176,16,138.6,0.933)","rgba(172,20,141.2,0.917)","rgba(168,24,143.9,0.900)","rgba(164,28,146.5,0.883)",
      "rgba(160,32,149.2,0.867)","rgba(156,36,151.8,0.850)","rgba(152,40,154.5,0.833)","rgba(148,44,157.1,0.817)",
      "rgba(144,48,159.8,0.800)","rgba(140,52,162.4,0.783)","rgba(136,56,165.0,0.767)","rgba(132,60,167.7,0.750)",
      "rgba(128,64,170.3,0.733)","rgba(124,68,173.0,0.717)","rgba(120,72,175.6,0.700)","rgba(116,76,178.3,0.683)",
      "rgba(112,80,180.9,0.667)","rgba(108,84,183.6,0.650)","rgba(104,88,186.2,0.633)","rgba(100,92,188.9,0.617)",
      "rgba(96,96,191.5,0.600)","rgba(92,100,194.1,0.583)","rgba(88,104,196.8,0.567)","rgba(84,108,199.4,0.550)",
      "rgba(80,112,202.1,0.533)","rgba(76,116,204.7,0.517)","rgba(72,120,207.4,0.500)","rgba(68,124,210.0,0.483)",
      "rgba(64,128,212.7,0.467)","rgba(60,132,215.3,0.450)","rgba(56,136,218.0,0.433)","rgba(52,140,220.6,0.417)",
      "rgba(48,144,223.3,0.400)","rgba(44,148,225.9,0.383)","rgba(40,152,228.5,0.367)",
  ...
  },
  {
    ...
    },
    {
      ...
      title: "T-C [%]",
      colors: [
        "rgba(192.0,192.0,192.0,0.7)","rgba(198.3,198.3,198.3,0.63)","rgba(204.6,204.6,204.6,0.56)",
        "rgba(210.9,210.9,210.9,0.49)","rgba(217.2,217.2,217.2,0.42)","rgba(223.5,223.5,223.5,0.35)",
