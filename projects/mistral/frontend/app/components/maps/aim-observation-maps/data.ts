export const COLOR_RANGES = {
  ...
  t2m: [
    ...
    { min: 283.15, color: "#21BB0E", textColor: null },
    { min: 281.15, color: "#07A127", textColor: null },
    { min: 279.15, color: "#62AF88", textColor: null },
    ...
    { min: 243.15, color: "#78048D", textColor: null },
    { min: Infinity, color: "#64007F", textColor: null },
  ],
  prp: [
