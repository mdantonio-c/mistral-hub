export const COLOR_RANGES = {
  ...
  t2m: [
    ...
    { min: 317.15, color: "#FFDCDC", textColor: null }, // 44
    { min: 315.15, color: "#FFB4B4", textColor: null }, // 42
    { min: 313.15, color: "#F0A0A0", textColor: "#fff" }, // 40
    { min: 311.15, color: "#B46464", textColor: "#fff" }, // 38
    { min: 309.15, color: "#640000", textColor: "#fff" }, // 36
    { min: 307.15, color: "#7C0000", textColor: "#fff" }, // 34
    { min: 305.15, color: "#AF0F14", textColor: "#fff" }, // 32
    { min: 303.15, color: "#C41A0A", textColor: "#fff" }, // 30
    { min: 301.15, color: "#E83709", textColor: "#fff" }, // 28
    { min: 299.15, color: "#F46D0B", textColor: null }, // 26
    { min: 297.15, color: "#F4880B", textColor: null }, // 24
    { min: 295.15, color: "#F4BD0B", textColor: null }, // 22
    { min: 293.15, color: "#F4D90B", textColor: null }, // 20
    { min: 291.15, color: "#F3FB01", textColor: null }, // 18
    { min: 289.15, color: "#CEF003", textColor: null }, // 16
    { min: 287.15, color: "#9CE106", textColor: null }, // 14
    { min: 285.15, color: "#52CA0B", textColor: "#fff" }, // 12
    { min: 283.15, color: "#21BB0E", textColor: "#fff" }, // 10
    { min: 281.15, color: "#07A127", textColor: "#fff" }, // 8
    { min: 279.15, color: "#62AF88", textColor: null }, // 6
    { min: 277.15, color: "#87D3AB", textColor: null }, // 4
    { min: 275.15, color: "#9FEEC8", textColor: null }, // 2
    { min: 273.15, color: "#BBFFE2", textColor: null }, // 0
    { min: 271.15, color: "#85C8FF", textColor: "#fff" }, // -2
    { min: 269.15, color: "#5bb4ff", textColor: "#fff" }, // -4
    { min: 267.15, color: "#0082EF", textColor: "#fff" }, // -6
    { min: 265.15, color: "#0070cc", textColor: "#fff" }, // -8
    { min: 263.15, color: "#0062af", textColor: "#fff" }, // -10
    { min: 261.15, color: "#00528f", textColor: "#fff" }, // -12
    { min: 259.15, color: "#003C7F", textColor: "#fff" }, // -14
    { min: 257.15, color: "#00277A", textColor: "#fff" }, // -16
    { min: 255.15, color: "#002066", textColor: "#fff" }, // -18
    { min: 253.15, color: "#f862f1", textColor: "#fff" }, // -20
    { min: 251.15, color: "#f627eb", textColor: "#fff" }, // -22
    { min: 249.15, color: "#d41dd1", textColor: "#fff" }, // -24
    { min: 247.15, color: "#b000e0", textColor: "#fff" }, // -26
    { min: 245.15, color: "#8000a3", textColor: "#fff" }, // -28
    { min: 243.15, color: "#57007f", textColor: "#fff" }, // -30
    { min: Infinity, color: "#3e007f", textColor: "#fff" },
  ],
  prp: [
