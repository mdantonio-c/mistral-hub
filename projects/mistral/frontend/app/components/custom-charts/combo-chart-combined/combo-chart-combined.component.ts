...
@Component({
  selector: "combo-chart-combined-component",
  templateUrl: "./combo-chart-combined.component.html",
  styleUrls: ["./combo-chart-combined.component.scss"],
  encapsulation: ViewEncapsulation.None,
})
export class DoubleLineChartComponent extends BaseChartComponent {
