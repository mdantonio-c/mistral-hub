import {DerivedVariables, RapydoBundle, RapydoResponse, StorageUsage, SummaryStats} from "./data.service";

export const MockStorageUsageResponse: RapydoBundle<StorageUsage> = {
    "Meta": {
        "data_type": "<class 'dict'>",
        "elements": 2,
        "errors": 0,
        "status": 200
    }, "Response": {"data": {"quota": 5368709120, "used": 2973844488}, "errors": null}
};
...
export const MockSummaryStatsResponse: RapydoBundle<SummaryStats> = {
    ...
    "Response": {
        "data": {"b": [2019, 9, 1, 12, 0, 0], "c": 637000, "e": [2019, 10, 9, 12, 0, 0], "s": 456198422400},
        "errors": null
    }
};

export const MockDatasetsResponse: RapydoBundle<any> = {
    "Meta": {
...
export const MockFiltersResponse: RapydoBundle<any> = {
    "Meta": {"data_type": "<class 'dict'>", "elements": 1, "errors": 0, "status": 200}, "Response": {
        "data": {
            "items": {
                "area": [{
