...
export const MockGribTemplateResponse: any = [
  {
    files: ["/uploads/965812e7-b8d3-45d3-b05a-6ee31d347ea5/shp/it_100km.grib"],
    type: "grib",
  },
];
...
export const MockShapeTemplateResponse: any = [
  {
    files: ["/uploads/965812e7-b8d3-45d3-b05a-6ee31d347ea5/shp/it_100km.shp"],
    type: "shp",
  },
];
...
export const MockFiltersResponse: any = {
  items: {
    ...
    run: [
      { desc: "MINUTE(00:00)", s: "MINUTE", t: "run", va: 0 },
      {
        desc: "MINUTE(12:00)",
        s: "MINUTE",
        t: "run",
...
export const MockRequestsResponse: any = [
  {
    args: {
      ...
      filters: {
        ...
        product: [
          { desc: "T Temperature K", or: 80, pr: 11, s: "GRIB1", ta: 2 },
        ],
    ...
    fileoutput:
      "data-20191121T080202Z-9896b1d0-9ae4-456a-899d-78cb904b3c02.grib",
    filesize: 341539308,
    id: 246,
    name: "Test-scheduled",
    schedule_id: 11,
  ...
  },
  {
    args: {
      ...
      postprocessors: [
        { type: "additional_variables", variables: ["B11001", "B11002"] },
      ],
      reftime: null,
    },
    end_date: "2019-10-31T14:15:01.868711",
    fileoutput:
      "data-20191031T141501Z-fa40e3eb-42f3-4963-bd43-9bd324955952.grib",
    filesize: 103382016,
    id: 199,
    name: "test-vento",
    status: "SUCCESS",
